...
/**
 * A specialized editor for the Present Illness section, featuring quick templates, a phrase bank,
...
public class IMSPresentIllness {
    ...
    public IMSPresentIllness(TextArea sourceTextArea, AbbreviationService abbreviationService) {
    ...
    private void createEditorWindow() {
        ...
        editorStage.setTitle("Present Illness Editor");
    ...
    private VBox createTopSection() {
        return new VBox(5,
                ...
                createStyledLabel("Edit the patient's present illness. Use templates or the phrase bank.", "-fx-text-fill: #666;"),
    ...
    private VBox createCenterSection() {
        ...
        return new VBox(10,
                ...
                createTemplatesGrid(),
                createStyledLabel("Present Illness Text:", "-fx-font-weight: bold;"),
                editorTextArea,
    ...
    private GridPane createTemplatesGrid() {
        ...
        grid.setVgap(5);
        int cols = 5;
        for (int i = 0; i < piTemplates.length; i++) {
            String template = piTemplates[i];
